...
function sumArray(sumArr) { //eslint-disable-line
  var addArr = sum(testArray[0],testArray[1])[0];
  var addArr2 = sum(addArr,testArray[2]);

  var msgArr = testArray[0]+ ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + addArr2[0] + ' is their sum.'

  var arrSum = [];
  arrSum.push(addArr2[0]);
  arrSum.push(msgArr);
  
  // console.log(addArr2) // testing to see what addArr2 is
  return arrSum;
...
function multiplyArray(multArr) { //eslint-disable-line
  var mulArr = multiply(testArray[0],testArray[1])[0];
  var mulArr2 = multiply(mulArr,testArray[2]);

  var msgAr = 'The numbers ' + testArray[0]+ ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + mulArr2[0] + '.'
  
  var arrMul = [];
  arrMul.push(mulArr2[0]);
  arrMul.push(msgAr);
